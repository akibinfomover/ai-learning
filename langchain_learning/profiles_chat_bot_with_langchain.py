...
class ProfilesChatBot:
    ...
    def load_profiles_from_db(self):
        """Fetches profiles from MongoDB and builds context string"""
        try:
            ...
            print("Using empty profiles context. Please check your MongoDB configuration.")
            self.profiles_context = "No profiles available."

    def chat(self, user_question: str):
        """Uses LangChain to respond to user questions about profiles"""

        # Define prompt template
        system_template = (
            "You are a helpful assistant with access to professional profiles.\n\n"
